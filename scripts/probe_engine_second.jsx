#targetengine "estimer_g2_second"
// probe_engine_second.jsx — G2/G7: first read in ANOTHER fresh named engine.
// Each distinct engine should get its OWN first-read (its init µs), i.e. the
// timer is per-thread/per-engine, not process-global.
(function(){
  ...
  var r={ok:true,
    host:{probe:'probe_engine_second.jsx',engineName:safe(function(){return String($.engineName)},null),nowIso:safe(function(){return String(new Date())},null)},
    context:{engine:'estimer_g2_second (created by #targetengine for this run)'},
